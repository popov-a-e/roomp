...
//
//    Route::get('/{code}', 'ReservationController@retrieve');
//  });
//
//  Route::get('/successful_payment', 'ReservationController@successfulPayment');
//
//  Route::get('/lang/{locale}', 'HomeController@changeLocale');
//  Route::get('/currency/{currency}', 'HomeController@changeCurrency');
//
//  Route::any('/search', 'SearchController@index');
//
//  Route::post('/hotels', 'SearchController@getHotels');
//  Route::any('/rooms', 'SearchController@getRooms');
//
//  //Route::get('/admin', 'AdminController@setAvailability');
//
//  Route::get('/hotel/{pretty_url}', 'HotelController@index');
//
//  Route::get('/hotel_rooms', 'HotelController@rooms');
//
//  Route::post('/promo/check', 'ReservationController@checkPromo');
//
//  Route::any('/book', 'ReservationController@book');
//  Route::get('/pay/status/{code}', 'ReservationController@checkStatus');
//  Route::get('/pay/{code}', 'ReservationController@pay');
//  Route::get('/pay_with_confirmation/{code}', 'ReservationController@payWithEmail');
//  /*
//    Route::get('/check', function(\Roomp\Drivers\OTA\Wubook\Repository $repository) {
//      $repository->handleReservation(1502725910, 1503758235);
//    });*/
//
//  Route::group(['prefix' => 'auth'], function () {
//    Route::get('/register', 'Auth\RegisterController@register');
//    Route::get('/repeat_sms', 'Auth\RegisterController@repeatVerificationSMS');
//    Route::get('/login', 'Auth\LoginController@login');
//    Route::get('/logout', 'Auth\LoginController@logout');
//    Route::get('/password/reset/email', 'Auth\ForgotPasswordController@resetByEmail');
//    Route::get('/password/reset/phone', 'Auth\ForgotPasswordController@resetByPhone');
//    Route::get('/password/reset/repeat_sms', 'Auth\ForgotPasswordController@repeatVerificationSMS');
//    Route::get('/password/reset/{token}', 'Auth\ResetPasswordController@index');
//  });
//
//  Route::group(['prefix' => 'profile', 'middleware' => \Roomp\Http\Middleware\RedirectIfNotAuthentificated::class], function () {
//    Route::get('/', 'HomeController@profile');
//    Route::get('/reservations', 'HomeController@getReservations');
//    Route::post('/change', 'HomeController@changeUser');
...
//  Route::get('guest', 'StaticPageController@guest');
//};
