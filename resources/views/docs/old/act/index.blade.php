  ...
  <div class="act" style="position: relative">
    ...
    <table style="width: 49%; float: left; border: none" class="requisities">
      ...
      <tr>
        ...
        <td>
          <span class="inn">1659174106</span>
          <span style="padding-left: 10px; padding-right: 10px">КПП</span>
          <span class="inn">165901001</span>
        </td>
      </tr>

      <tr style="padding-top: 20px">
        <td class="requisities-name">Адрес</td>
        <td class="inn"><span>420101, Татарстан Респ, г Казань, ул Профессора Камая, д 8А, офис 1003</span></td>
      </tr>

      <tr>
        <td class="requisities-name">Р/с</td>
        <td class="inn"><span>40702810103270004295</span></td>
      </tr>

      <tr>
        <td class="requisities-name">К/с</td>
        <td class="inn"><span>30101810845250000999</span></td>
      </tr>

      <tr>
        <td class="requisities-name">Банк</td>
        <td class="inn"><span>ТОЧКА ПАО БАНКА "ФК ОТКРЫТИЕ" г. МОСКВА</span></td>
      </tr>

      <tr>
        <td class="requisities-name">БИК</td>
        <td class="inn"><span>044525999</span></td>
      </tr>
