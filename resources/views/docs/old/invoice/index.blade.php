...
<div class="container">
  <div class="invoice">
    ...
    <p>
      420101, Татарстан Респ, г Казань, ул Профессора Камая,
      <br>д 8А, офис 1003 <br>
      Телефон: 8-800-777-17-56<br>
      Эл.почта: help@roomp.co<br>
    ...
    <table class="bank">
      <tr>
        <td style="width: 58%" class="border-bottom-none">ТОЧКА ПАО БАНКА "ФК ОТКРЫТИЕ" г. МОСКВА</td>
        <td style="width: 7%">БИК</td>
        <td style="width: 35%" class="border-bottom-none">044525999</td>
      </tr>

      <tr>
        <td style="width: 58%; padding-top: 20px; font-size: 10px">Банк получателя</td>
        <td style="width: 7%; padding-bottom: 20px">Сч. №</td>
        <td style="width: 35%; padding-bottom: 20px">30101810845250000999</td>
      </tr>
      ...
      <tr>
        <td style="width: 58%; position: relative">
          ...
          <span style="">ИНН</span>
          <span style="padding-left: 20px; padding-right: 20px">1659174106</span>
          <span style="">КПП</span>
          <span style="">165901001</span>

        </td>

        <td style="width: 7%" class="border-bottom-none">Сч. №</td>
        <td style="width: 35%" class="border-bottom-none">40702810103270004295</td>
      </tr>
    ...
    <div style="float: left; position: relative">
      @include('base64.stamp_old', ['style' => 'width: 300px; top: -30px; left: 230px; position: absolute;'])
