    ...
    <table>
      <tr>
        <td colspan="3" style="height: 60px;">
          <img class='logo-thumb' src="{{base_path('public/img/logo-thumb.png')}}" />
          <img class="logo" src="{{base_path('public/img/logo.png')}}" />
        </td>
      </tr>
      <tr>
        <td>Agency Agreement – Offer N _________________</td>
        <td></td>
        <td>სააგენტო ხელშეკრულება - ოფერტა № _______</td>
      </tr>
      <tr>
        <td>Acceptance date: ____________________, 2017</td>
        <td></td>
        <td>აქცეპტის თარიღი: 2017 წლის ________________</td>
      </tr>
      <tr>
        <td>The city of ________________</td>
        <td></td>
        <td>__________________________</td>
      </tr>
      <tr>
        <td>This Agency Agreement is an offer of the Limited Liability Company ROOMP GEORGIA, hereinafter referred to as the
          Agent or Roomp, addressed to {{ $organization->name }}, hereinafter referred to as the Principal, to enter into an agency agreement on the
        ...
        <td>წინამდებარე სააგენტო ხელშეკრულება წარმოადგენს შეზღუდული საზოგადოება  შპს რუუმპ ჯორჯია-ს (შემდგომში მოხსენიენული
          როგორც „აგენტი“ ან „რუუმპ“) ოფერტას {{ $organization->name }}, რომელიც შემდგომ იწოდება „პრინციპალი“, მისამართით, რათა
      ...
      <tr>
        <td>The Principal agrees to notify the Agent of any no-show of Roomp’s Clients by email to partners@roomp.co and/or
          by making appropriate changes in the account on the Agent’s platform within 72 hours after the compulsory
        ...
        <td>პრინციპალი ვალდებულებას იღებს რუუმპის კლიენტების ნებისმიერი გამოუცხადებლობის შესახებ აცნობოს აგენტს ელექტრონული
          ...
          ჯავშნის იძულებითი მოხსნის შემდეგ 72 საათის განმავლობაში, რაც გათვალისწინებული არის წინამდებარე ხელშეკრულების
